...
as $$
    select case
        ...
        when p_date <= date '2026-10-25' then array[420,1140,1260]
...
begin
    ...
    -- Domingo fechado não pode ser reaberto por overrides ou encaixes.
    if p_date >= date '2026-11-01' and extract(isodow from p_date) = 7 then
        return false;
    end if;
